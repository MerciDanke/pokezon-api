    ...
    route do |routing|
      ...
      routing.on 'api/v1' do
          ...
          routing.on String do |id|
            routing.on 'likes' do
              ...
              routing.get do
                ...
                result = Service::PokeomonLike.new.call(requested: path_request)
                if result.failure?
                  failed = Representer::HttpResponse.new(result.failure)
                  routing.halt failed.http_status_code, failed.to_json
                end
        ...
        routing.on 'pokemons' do
          routing.on String do |poke_id|
            # GET /pokemons/{poke_id}
            # for pokemon is id (generated by PokeZon)
            routing.get do
              path_request = Request::PokemonPath.new(poke_id, request)
